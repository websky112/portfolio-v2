...
const Projects = [
  {
    ...
    feedback:
      "Watson's expertise as a frontend lead engineer and founding engineer have been instrumental in implementing high-quality solutions and significantly increasing commercial exchanges.",
  ...
  },
  {
    ...
    feedback:
      "Watson's contribution to Vivino, particularly the implementation of the OCR module and the successful rating system, showcases his expertise and valuable impact on the project.",
    clientName: "Riaz Azim",
  ...
  },
  {
    ...
    feedback:
      "Watson's expertise in addressing critical security issues and finding effective solutions was invaluable to ensuring the security of our front-end product.",
    clientName: "Debanjan",
